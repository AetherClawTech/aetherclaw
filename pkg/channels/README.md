# AetherClaw Channel System Refactor: Complete Development Guide

> **Branch**: `refactor/channel-system`
> **Status**: Active development (~40 commits)
> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/aetherclaw/internal/gateway/`
...
import (
    "github.com/AetherClawTech/aetherclaw/pkg/bus"
    "github.com/AetherClawTech/aetherclaw/pkg/channels"     // Reference parent package
    "github.com/AetherClawTech/aetherclaw/pkg/config"
    "github.com/AetherClawTech/aetherclaw/pkg/identity"      // New
    "github.com/AetherClawTech/aetherclaw/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/aetherclaw/internal/gateway/helpers.go
import (
    _ "github.com/AetherClawTech/aetherclaw/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/AetherClawTech/aetherclaw/pkg/channels/discord"
    _ "github.com/AetherClawTech/aetherclaw/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/AetherClawTech/aetherclaw/pkg/channels"
    "github.com/AetherClawTech/aetherclaw/pkg/config"
    "github.com/AetherClawTech/aetherclaw/pkg/identity"
...
// cmd/aetherclaw/internal/gateway/helpers.go
import (
    _ "github.com/AetherClawTech/aetherclaw/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom AetherClaw native protocol channel that receives messages via webhook.