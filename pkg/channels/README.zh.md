# AetherClaw Channel System 重构：完整开发指南

> **分支**: `refactor/channel-system`
> **状态**: 活跃开发中（约 40 commits）
> **影响范围**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/aetherclaw/internal/gateway/`
...
import (
    "github.com/AetherClawTech/aetherclaw/pkg/bus"
    "github.com/AetherClawTech/aetherclaw/pkg/channels"     // 引用父包
    "github.com/AetherClawTech/aetherclaw/pkg/config"
    "github.com/AetherClawTech/aetherclaw/pkg/identity"      // 新增
    "github.com/AetherClawTech/aetherclaw/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/AetherClawTech/aetherclaw/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/AetherClawTech/aetherclaw/pkg/channels/discord"
    _ "github.com/AetherClawTech/aetherclaw/pkg/channels/your_new_channel"  // 新增
)
```
...
4. **Pico Protocol**：`pkg/channels/pico/` 实现了一个自定义的 AetherClaw 原生协议 channel，通过 webhook 接收消息。