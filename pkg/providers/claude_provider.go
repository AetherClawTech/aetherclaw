...
import (
	...
	anthropicprovider "github.com/AetherClawTech/aetherclaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: aetherclaw auth login --provider anthropic")
		}
