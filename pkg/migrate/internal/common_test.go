...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.aetherclaw")
	assert.Equal(t, "/home/user/.aetherclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.aetherclaw/workspace/file.txt", "/home/user/.aetherclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".aetherclaw"), result)
}
