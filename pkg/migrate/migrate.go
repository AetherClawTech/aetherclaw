...
import (
	...
	"github.com/AetherClawTech/aetherclaw/pkg/migrate/internal"
	"github.com/AetherClawTech/aetherclaw/pkg/migrate/sources/openclaw"
)
...
func (m *MigrateInstance) Run(opts Options) (*Result, error) {
	...
	fmt.Println("Migrating from Source to AetherClaw")
	fmt.Printf("  Source:      %s\n", sourceHome)
	fmt.Printf("  Target: %s\n", targetHome)
	fmt.Println()
	...
	if !opts.WorkspaceOnly {
		...
		if err != nil {
			...
			actions = append(actions, Action{
				...
				Description: "convert Source config to AetherClaw format",
			})
		}
	}
